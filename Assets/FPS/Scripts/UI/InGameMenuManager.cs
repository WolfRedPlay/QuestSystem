...
namespace Unity.FPS.UI
{
    public class InGameMenuManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullFindObject<DialogueUI, InGameMenuManager>(m_dialogueUI, this);

            m_QuestLogManager = FindObjectOfType<QuestLogManager>();
        ...
        void Update()
        {
            ...
            //                                  NEW                         NEW
            if (!MenuRoot.activeSelf && !m_dialogueUI.IsActive && !m_QuestLogManager.IsActive && Input.GetMouseButtonDown(0))
            {
